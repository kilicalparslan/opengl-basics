...
int main() 
{
    ...
    Shader shader("assets/shaders/4_advanced-opengl/framebuffers.vert", "assets/shaders/4_advanced-opengl/framebuffers.frag");
    Shader screenShader("assets/shaders/4_advanced-opengl/framebuffers_screen.vert", "assets/shaders/4_advanced-opengl/framebuffers_screen.frag");
