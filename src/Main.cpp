...
int main() 
{
    ...
    Shader shader("assets/shaders/4_advanced-opengl/cubemaps.vert", "assets/shaders/4_advanced-opengl/cubemaps.frag");
    Shader skyboxShader("assets/shaders/4_advanced-opengl/skybox.vert", "assets/shaders/4_advanced-opengl/skybox.frag");
