...
int main() 
{
    ...
    Shader shader("assets/shaders/5_advanced-lighting/normal_mapping.vert", "assets/shaders/5_advanced-lighting/normal_mapping.frag");
...
unsigned int loadTexture(char const* path)
{
    ...
    if (data)
    {
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, format == GL_RGBA ? GL_CLAMP_TO_EDGE : GL_REPEAT); // for this tutorial: use GL_CLAMP_TO_EDGE to prevent semi-transparent borders.
